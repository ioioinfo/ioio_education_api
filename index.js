...
server.register([
    ...
    },
    {
      ...
      register: require('./server/assets/index.js')
        ...
        register: require('./server/controller/lesson_plans_controller.js')
    },{
        register: require('./server/controller/lessons_controller.js')
    },{
        register: require('./server/controller/learning_task_controller.js')
    },{
        register: require('./server/controller/grade_levels_controller.js')
    },{
        register: require('./server/controller/teachers_types_controller.js')
    },{
        register: require('./server/controller/exams_controller.js')
    },{
    ...
    {
        register: require('./server/controller/register_results_controller.js')
    },
